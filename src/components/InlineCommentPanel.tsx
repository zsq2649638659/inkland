              ...
              <div className="comment-main">
                ...
                <div className="comment-body">
                  ...
                  <div className="comment-actions">
                    ...
                    <button className="comment-action-btn" aria-label="回复" onClick={() => { setReplyingTo(replyingTo === comment.id ? null : comment.id); setReplyText(""); }}><SiteIcon name="fa-comment-dots" variant="outline" hoverVariant="solid" /> {Math.max(comment.reply_count || 0, comments.filter((reply) => reply.parent_id === comment.id).length)}</button>
                    <button
                      ...
                      return <div className="nested-comment" id={`comment-${reply.id}`} key={reply.id}>
                        ...
                        <div className="comment-body">
                          ...
                          <div className="comment-actions">
                            ...
                            <button className="comment-action-btn" aria-label="回复" onClick={() => { setReplyingTo(replyingTo === reply.id ? null : reply.id); setReplyText(""); }}><SiteIcon name="fa-comment-dots" variant="outline" hoverVariant="solid" /> {reply.reply_count || 0}</button>
