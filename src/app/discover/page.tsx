      ...
      <div className="main-container">
        ...
        <main className="content-area">
          <div className="page-header interest-discover-header">
            ...
            <Link className="btn-ghost" href="/profile-settings">修改兴趣</Link>
          </div>
          ...
          {(terms.length > 0 || domains.length > 0) && posts === null ? (
            ...
            <EmptyState icon="fa-compass" title="还没有选择兴趣" description="选择感兴趣的内容后，这里会展示对应发现。" actionLabel="设置兴趣" actionHref="/profile-settings" />
          ) : posts?.length === 0 ? (
            <EmptyState icon="fa-compass" title="暂时没有匹配内容" description="可以修改兴趣选择，或稍后再来看看。" actionLabel="修改兴趣" actionHref="/profile-settings" />
          ) : (
